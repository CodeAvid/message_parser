...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    final transactionInfo = TransactionInfo(
        ...
        iccString:
            '9F260877EA915B316859459F2701409F10120110650003020000000000000000000000FF9F370449EC37F29F360203EF950504800000009A032004179C01009F02060000000100005F2A020566820239009F1A0205669F34034103029F3303E0F0C89F3501228407A00000000410109F',
        iccData: ICCData(
    ...
    final res =
        await _parser.parseKimonoPurchaseRequest(terminalInfo, transactionInfo);
    setState(() {
      data = res;
    });
  }
